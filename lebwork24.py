a=int (input("Enter multiplication table start number: "))
b=int (input("Enter multiplication table end number: "))
...
"""
output:
Enter multiplication table start number: 1
Enter multiplication table end number: 20
